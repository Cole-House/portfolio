  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">Full-Stack and AI</span> . I enjoy building{" "}
        <span className="italic">web-apps</span> that improve{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/cole-house-6b188722a/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          ...
          href="https://github.com/Cole-House"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
